...
export const metadata = {
  ...
  description:
    'Algumas observações sobre o que eu entendo sobre aprender em public e porquê isso é importante',
  keywords: ['aprender', 'publicamente', 'digital garden'],
  authors: {
    name: 'David Costa',
  },
  alternates: {
    canonical: '/articles/pt-br/my-notes-about-learning-in-public',
  },
};
