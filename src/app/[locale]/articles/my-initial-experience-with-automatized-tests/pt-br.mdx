...
export const metadata = {
  ...
  tags: ['life', 'tests'],
  description:
    'Um pouco da experiêcia com testes automatizados e contar sobre minha experiência inicial com isso.',
  keywords: ['testes', 'automatizados', 'experiência', 'inicial'],
  authors: {
    name: 'David Costa',
  },
  alternates: {
    canonical: '/pt-br/articles/my-initial-experience-with-automatized-tests',
  },
};
