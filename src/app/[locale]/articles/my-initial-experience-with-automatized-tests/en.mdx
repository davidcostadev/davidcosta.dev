...
export const metadata = {
  ...
  tags: ['life', 'tests'],
  description:
    'A little about my history with automatized tests and my initial experience with it.',
  keywords: ['tests', 'automatized tests', 'testing'],
  authors: {
    name: 'David Costa',
  },
  alternates: {
    canonical: '/en/articles/my-initial-experience-with-automatized-tests',
  },
